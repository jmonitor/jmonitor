 ...
 *     },
 * }
 * @psalm-type JmonitorConfig = array{
 *     project_api_key?: scalar|Param|null, // You can find it in your jmonitor.io settings. Leave empty to disable sending. // Default: null
 *     http_client?: scalar|Param|null, // Name of a Psr\Http\Client\ClientInterface service. Optional. If null, Psr18ClientDiscovery will be used. // Default: null
 *     logger?: scalar|Param|null, // Name of a Psr\Log\LoggerInterface service. // Default: null
 *     collectors?: array{
 *         mysql?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             connection?: scalar|Param|null, // Doctrine DBAL connection service id used to query MySQL. // Default: "doctrine.dbal.default_connection"
 *             db_name?: scalar|Param|null, // Db name of your project.
 *             status?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *             },
 ...
 *                 enabled?: bool|Param, // Default: true
 *             },
 *             slow_queries?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *                 limit?: int|Param, // Maximum number of results to return (1–10). // Default: 5
 *                 min_exec_count?: int|Param, // Minimum number of executions required to include a query. // Default: 1
 *                 min_avg_time_ms?: int|Param, // Minimum average execution time in ms for a query to be included. // Default: 0
 *                 order_by?: scalar|Param|null, // Column used for sorting. Allowed values: sum, avg, max. // Default: "avg"
 *             },
 *             information_schema?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *             },
 *         },
 *         postgresql?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             connection?: scalar|Param|null, // Doctrine DBAL connection service id used to query PostgreSQL. // Default: "doctrine.dbal.default_connection"
 *             schema?: scalar|Param|null, // Schema inspected by the database collector. // Default: "public"
 *             activity?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *             },
 *             settings?: bool|array{
 ...
 *                 enabled?: bool|Param, // Default: true
 *                 limit?: int|Param, // Maximum number of results to return (1–10). // Default: 5
 *                 min_exec_count?: int|Param, // Minimum number of executions (calls) required to include a query. // Default: 1
 *                 min_avg_time_ms?: float|Param, // Minimum mean execution time in ms for a query to be included. // Default: 0
 *                 order_by?: scalar|Param|null, // Column used for sorting. Allowed values: avg, total, max. // Default: "avg"
 *                 auto_create_extension?: bool|Param, // Automatically run "CREATE EXTENSION IF NOT EXISTS pg_stat_statements" when missing. Requires sufficient privileges. // Default: false
 *             },
 *         },
 *         apache?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             server_status_url?: scalar|Param|null, // Url of apache mod_status. // Default: "http://localhost/server-status"
 *         },
 *         nginx?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             endpoint?: scalar|Param|null, // Url of nginx stub_status. // Default: "http://localhost/nginx_status"
 *         },
 *         system?: bool|array{
 *             enabled?: bool|Param, // Default: false
 ...
 *         redis?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             dsn?: scalar|Param|null, // Redis DSN. See https://symfony.com/doc/current/components/cache/adapters/redis_adapter.html // Default: null
 *             adapter?: scalar|Param|null, // Redis or Predis service name // Default: null
 *         },
 *         php?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             endpoint?: scalar|Param|null, // Url of exposed php metrics endpoint. // Default: null
 *         },
 *         caddy?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             endpoint?: scalar|Param|null, // Url of Caddy (or FrankenPHP) metrics endpoint. // Default: "http://localhost:2019/metrics"
 *             frankenphp?: bool|Param, // Enable FrankenPhp metrics collection // Default: false
 *         },
 *         symfony?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             flex?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *                 command?: scalar|Param|null, // Command to collect Flex recipes metrics // Default: "composer recipes -o"
 *                 timeout?: int|Param, // Timeout in seconds for the Flex recipes command // Default: 5
 *             },
 *             scheduler?: bool|Param, // Collect Symfony Scheduler metrics. // Default: true
 *             messenger?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *                 command?: scalar|Param|null, // Command to collect messenger stats. Default null uses "php bin/console messenger:stats --format=json". // Default: null
 *                 timeout?: int|Param, // Timeout in seconds for the messenger stats command. // Default: 3
 *             },
 *         },
 *     },
 * }
