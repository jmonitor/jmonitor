...
#[AsTaggedItem(Metric::SymfonyVersion->value)]
class SymfonyVersion implements BasicMetricInterface
{
    use BagAwareTrait;
    ...
    {
        return Metric::SymfonyVersion;
    }

    public function configureBasicDto(BasicDto $dto, array $options = []): void
    {
        $dto
            ->setValue($this->getSymfonyBag()->symfonyVersion)
    ...
    {
        $cycle = $this->endOfLife->getCycle($value, 'https://endoflife.date/api/symfony.json');
